...
HEADERS = {
    ...
    "Blade-Auth": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9..LClBLgWzwyGWRjX5mdaENlrakNA6Tz2G7FobrYa9EVkZyj0T5bbzVR0mcFXdb__sQwoF3BLDQW2Se_OHI1jqHQ",
    "Connection": "keep-alive",
    "Cookie": "_fbp=fb.1.1752244251179.271610516261592866; JSESSIONID=P-RSJBCi3HdG_tu9Ho1i7QIZYD6L43nyB-Rsqu5-",
...
def fetch_historical_data(record_count=2000):
    ...
    while total_records_fetched < record_count:
        params = {
            "subServiceCode": "RG1M",
            "size": 500,  # Giảm từ 2000 xuống 500
            "current": page
        }
        retries = 0
        while retries < max_retries:
            try:
                ...
                if response.status_code == 200:
                    ...
                    print(f"[{current_time}] Fetched page {page}/{pages}, total records: {total_records_fetched}/{record_count} (Total available: {total})")

                    if total_records_fetched >= record_count or page >= pages:
                        break
                    page += 1
